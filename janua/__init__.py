...
jdb = JanuaDB(os.path.join(conf_dir, 'janua.db'))
mail_queue = PersistentSqliteQueue(os.path.join(conf_dir, 'mailqueue.db'))
sms_queue = PersistentSqliteQueue(os.path.join(conf_dir, 'smsqueue.db'))
