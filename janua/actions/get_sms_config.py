...
class GetSmsConfig(Action):
    ...
    def web(self):
        ...
        jsonactions = get_custom_action_repr('sms', filtered, authorized_actions)
        jsonactions.update({'phone_token': admin.phone_token})
